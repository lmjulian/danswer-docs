---
title: LM Studio
description: 'Configure Danswer to use LM Studio'
---
...
## What is LM Studio
LM Studio provides an easy way to host LLMs locally and to provide a REST API for the model.
Refer to the following resources to get started:
- https://lmstudio.ai/
- https://lmstudio.ai/docs

## Set Danswer to use LM Studio
...
**Note**: For the API Base, you should point Danswer to wherever Ollama is running. To point to 
